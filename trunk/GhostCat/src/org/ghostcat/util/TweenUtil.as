package org.ghostcat.util
{
	...
	import org.ghostcat.util.easing.Linear;

	[Event(name="tween_start",type="org.ghostcat.events.TweenEvent")]
	[Event(name="tween_end",type="org.ghostcat.events.TweenEvent")]
	[Event(name="tween_update",type="org.ghostcat.events.TweenEvent")]
