...
public class BindingUtils
{
     ...
     * 
     */
    public static function dispatchChangeEvent(site:Object, prop:String):void
	{
		(site as EventDispatcher).dispatchEvent(PropertyChangeEvent.createUpdateEvent(site,prop,site[prop],site[prop]));
	}
}
